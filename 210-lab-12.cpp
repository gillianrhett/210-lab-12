...
#include <cmath> // for checking whether file contents are ints
using namespace std;
...
*  This simulates a situation where we keep track of how many
...
*/
    ...
    for (int item : visitors) cout << item << " ";
    cout << endl;
    cout << "16. accumulate function: " << accumulate(visitors.begin(), visitors.end(), 0);
    return 0;
}